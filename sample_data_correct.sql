...
INSERT INTO products (name, description, price, images, category_id, is_visible, stock) VALUES
('NYX-1 Smart Sensor', 'Smart PIR Motion Sensor with 24-month battery life and Adaptive AI Learning.', 129.99, ARRAY['https://via.placeholder.com/400'], (SELECT id FROM categories WHERE slug = 'smart-sensors'), true, 50),
('NYX-Bulb Smart LED', 'Smart LED bulb with 16 million colors and voice control integration.', 39.99, ARRAY['https://via.placeholder.com/400'], (SELECT id FROM categories WHERE slug = 'smart-lighting'), true, 100),
('NYX-Cam Security Camera', '4K security camera with night vision and motion detection.', 199.99, ARRAY['https://via.placeholder.com/400'], (SELECT id FROM categories WHERE slug = 'smart-security'), true, 25);
