...
const HomePage: React.FC<HomePageProps> = ({ navigateTo }) => {
  ...
  const handleAddToCart = (product: Product) => {
    ...
    <div className="min-h-screen bg-dark text-white">
      {/* Hero Section */}
      <section className="relative pt-0 pb-0 md:pt-0 md:pb-0 overflow-hidden min-h-screen flex items-center">
        {/* Animated Background */}
        ...
        <div className="container mx-auto px-4 relative z-10 -mt-16 md:-mt-20">
          <div className="max-w-5xl mx-auto text-center">
            ...
            <h1 className="text-6xl md:text-8xl font-bold tracking-tight mb-3 leading-tight">
              The Future of
        ...
        <div className="absolute bottom-24 left-1/2 transform -translate-x-1/2 animate-bounce">
          <div className="w-6 h-10 border-2 border-white/70 rounded-full flex justify-center hover:border-white/90 transition-colors cursor-pointer">
              ...
              {featuredProducts.map((product) => (
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <p className="text-gray-400 text-sm mb-4">{product.tagline || product.description?.substring(0, 50) + '...' || 'Smart home device'}</p>
