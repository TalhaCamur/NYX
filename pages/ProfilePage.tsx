                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    {activeTab === 'profile' && (
                        <div className="space-y-6">
                            ...
                            <div className="relative bg-gradient-to-br from-white/[0.08] to-white/[0.02] backdrop-blur-2xl rounded-3xl border border-white/20 p-10 shadow-2xl overflow-hidden">
                                {/* Animated gradient orb */}
                                    ...
                                    <div className="flex items-center justify-between mb-8">
                                        <div className="flex items-center gap-4">
                                            <div className="relative">
                                                ...
                                                <div className="relative w-16 h-16 bg-gradient-to-br from-green-500/30 to-emerald-500/30 rounded-2xl flex items-center justify-center border border-green-500/30">
                                            ...
                                            <div>
                                                <h3 className="text-3xl font-black text-white tracking-tight">Contact Information</h3>
                                                {isEditing && (
                                                    <div className="flex items-center gap-2 mt-1">
                                                        <div className="w-2 h-2 bg-green-400 rounded-full animate-pulse"></div>
                                                        <span className="text-sm text-green-400 font-bold tracking-wide">EDIT MODE ACTIVE</span>
                                                    </div>
                                                )}
                                            </div>
                                        </div>
                                        <div className="px-4 py-2 bg-green-500/10 border border-green-500/30 rounded-xl">
                                            <span className="text-xs font-bold text-green-400 tracking-widest">CONTACT</span>
                                        </div>
                                    </div>
                            ...
                            {isEditing && (
                                <div className="relative mt-10 pt-8 border-t-2 border-white/10">
                                    <div className="flex items-center gap-3 mb-6 px-4 py-3 bg-gradient-to-r from-green-500/10 to-emerald-500/10 rounded-2xl border border-green-500/20">
                                        <div className="relative">
                                            <div className="w-3 h-3 bg-green-400 rounded-full animate-pulse"></div>
                                            <div className="absolute inset-0 w-3 h-3 bg-green-400 rounded-full animate-ping"></div>
                                        </div>
                                        <span className="text-base font-black text-green-300 tracking-wide">READY TO SAVE YOUR CHANGES?</span>
                                    </div>
                                    <div className="flex gap-4">
                                        <button
                                            onClick={handleSave}
                                            className="flex-1 group relative px-8 py-5 bg-gradient-to-r from-green-500 via-emerald-500 to-green-600 text-white font-black rounded-2xl overflow-hidden transition-all duration-500 hover:shadow-2xl hover:shadow-green-500/50 hover:scale-105 flex items-center justify-center gap-3"
                                        >
                                            <div className="absolute inset-0 bg-gradient-to-r from-emerald-600 via-green-600 to-emerald-500 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                                            <svg className="w-6 h-6 relative z-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                                            </svg>
                                            <span className="relative z-10 text-lg tracking-wide">SAVE CHANGES</span>
                                            <svg className="w-5 h-5 relative z-10 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                                            </svg>
                                        </button>
                                        <button
                                            ...
                                            className="px-8 py-5 bg-white/5 border-2 border-white/20 text-gray-300 font-black rounded-2xl hover:bg-white/10 hover:border-white/30 transition-all duration-300 flex items-center gap-3 hover:scale-105"
                                        >
