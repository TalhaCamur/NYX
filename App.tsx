        ...
        <div className="w-full max-w-md p-8 md:p-12 bg-nyx-black rounded-2xl border border-nyx-gray/50">
            ...
            <div className="space-y-3">
                <button
                    ...
                    disabled={loading}
                    className="w-full flex justify-center items-center gap-3 bg-nyx-gray border border-gray-700 rounded-lg py-3 px-4 text-white hover:bg-nyx-gray/50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                >
                ...
                <div className="container mx-auto px-4 relative z-10">
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="prose prose-invert prose-lg max-w-none text-gray-300 leading-relaxed">
                            {/* Excerpt (Subheading) */}
                            {post.excerpt && (
                                <p className="text-xl text-gray-200 font-medium mb-8 leading-relaxed">{post.excerpt}</p>
                            )}
